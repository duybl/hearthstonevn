...
<xsl:template match="/atom:feed">
	...
	<!-- <script src="http://localhost:4000/assets/js/cardpopup.js"></script> -->
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000">Card</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/Cards/Druid/">Druid</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/Cards/Hunter/">Hunter</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/Cards/Mage/">Mage</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/Cards/Paladin">Paladin</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/Cards/Priest/">Priest</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/Cards/Rogue">Rogue</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/Cards/Shaman">Shaman</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/Cards/Warlock">Warlock</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/Cards/Warrior">Warrior</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000">Card Set</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/set/boomsdaypro/">The Boomsday Project</a></li>
